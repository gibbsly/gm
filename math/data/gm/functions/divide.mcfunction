...
$execute if data storage gm:check {type:1} summon item_display run function gm:zzz/divide_handling {var1:$(x),var2:$(y)}
$execute if data storage gm:check {type:2} summon item_display run function gm:zzz/divide_array {array:$(x),divisor:$(y)}
