...
execute if score cur_dp= arr_math.main matches 0 unless score cdp= arr_math.main matches 0 run scoreboard players add cdp= arr_math.main 1

#writing vals fro addition 
