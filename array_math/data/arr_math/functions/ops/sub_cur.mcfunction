...
execute if score hold= arr_math.main matches ..-1 run scoreboard players set temp= arr_math.main -1
execute if score hold= arr_math.main matches 0.. run scoreboard players set temp= arr_math.main 0
execute if score hold= arr_math.main matches ..-1 run scoreboard players operation hold= arr_math.main += base= arr_math.main
...
#loop condition
execute unless data storage arr_math:main {v1:{num:["end"]},v2:{num:["end"]}} run function arr_math:ops/sub_cur