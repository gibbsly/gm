...
data modify storage arr_math:main dc.out set value {num:[],base:10,dec:0,pol:1}
...
execute if score v1base= arr_math.main = v2base= arr_math.main run function arr_math:ops/do_dc

data remove storage arr_math:main dc
